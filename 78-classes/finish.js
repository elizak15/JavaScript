/** CHALLENGE 78 - Classes
 *
 * 1. Create the class "Fruit"
 *
 * 2. Each instance of this class must have
 * two properties of its own:
 * - title
 * - price
 *
 * 3. You should also add a "priceInfo" method, which will
 * will return a string containing the title and price of the fruit
 *
 * 4. The output in the console should match.
 */
